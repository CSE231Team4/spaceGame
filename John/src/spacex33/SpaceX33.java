...
public class SpaceX33 extends Application {   
    ...
    private void onUpdate() {
        ...
        for (Node powerup : powerups){
            powerup.setTranslateY(powerup.getTranslateY() + speed); //translates the asteroid down 12 pixels every update
            //asteroid.setRotate(asteroid.getRotate() + speed);
        ...
        if (rand_hold < 0.03 && rand_hold > 0.002) {
